...
class AnalyticsComponent implements OnInit {
  ...
  Future ngOnInit() async {
    ...
    await _resourcesLoaderService.loadScriptAsync(
        'packages/analytics/src/bower_components/chart.js/dist/',
        'Chart.min.js',
        false);
  ...
  void initChart1() {
    var data1 = <int>[28, 58, 38, 98, 39, 65, 98];

    var data2 = <int>[33, 38, 32, 61, 17, 15, 37];
  ...
  void initChart2() {
    var data1 = <int>[12, 86, 13, 72, 22, 63, 30];

    var data2 = <int>[43, 74, 93, 85, 66, 36, 79];
